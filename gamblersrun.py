...
# for nsteps, walklength, pforward in [(10, 5, 0.4), (10, 10, 0.4), (10, 20, 0.4)]:
	...
	# compile(program='gambler_{}_{}_{}'.format(nsteps, walklength, pforward), queries=['reached'], algo='exact')
